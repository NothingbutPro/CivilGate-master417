...
public class Intermediate_Level_Test_Fragment extends Fragment {
    ...
    int  px =0;
    int[] p = new  int[20];
    private List<Tests_Name> tests_recy_internames = new ArrayList<>();
    @Nullable
    @Override
...
//                    finish();
    ...
    public void onDetach() {
        ...
        tests_recy_internames.clear();
        try {
            tests_recy_inter.setAdapter(null);
...
//                        {
                        ...
                        testAdapter = new Test_Adapter(tests_recy_internames);
                        //      RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
                        LinearLayoutManager llm = new LinearLayoutManager(getActivity());
                        llm.setOrientation(LinearLayoutManager.VERTICAL);
                        tests_recy_inter.setLayoutManager(llm);
                        tests_recy_inter.setAdapter(testAdapter);
