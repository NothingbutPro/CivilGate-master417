...
public class Report_Dapter  extends RecyclerView.Adapter<Report_Dapter.MyViewHolder> {
    private List<Tests_Name> levelAdapterList;
    SessionManager sessionManager;

    public Report_Dapter(List<Tests_Name> levelAdapterList) {
...
//            Test_len = view.findViewById(R.id.testlenth);
    ...
    @NonNull
    @Override
    public Report_Dapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.exam_test, viewGroup, false);

        return new Report_Dapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull Report_Dapter.MyViewHolder myViewHolder, int i) {
